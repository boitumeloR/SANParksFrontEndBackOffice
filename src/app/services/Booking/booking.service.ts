...
export class BookingService {
  ...
  constructor(private http: HttpClient) { }
    ...
    getBookingEmployee(server) {
      const session: Session  = JSON.parse(localStorage.getItem('user'));
      return this.http.post<any>(`${server}/api/Booking/EmployeeFromSession`, session, this.httpOptions);
    }
}
